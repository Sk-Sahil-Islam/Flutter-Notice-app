      ...
      Padding(
        ...
        child: Column(
         ...
         // crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
            const Text("Sign In", style: TextStyle(fontFamily: 'Kanit', fontWeight: FontWeight.w300, fontSize: 22.0)),
            const Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Welcome", style: TextStyle(fontFamily: 'Kanit', fontWeight: FontWeight.normal, fontSize: 28.0, color: Color(0xFF8D8BC5))),
                Text(" back!", style: TextStyle(fontFamily: 'Kanit', fontWeight: FontWeight.normal, fontSize: 28.0)),
              ],
            ),
            ...
            ElevatedButton(
              ...
              child:const Text("Sign In", style: TextStyle(fontSize: 15.0, color: Color(0xFFF4F0F8))
              ),
            ),
            ...
            ConnectWith(
              ...
              onSignInWithFacebook: () {
                // launcherFacebook(['email', 'public_profile'])
              },
            ),
          ],
        ),
